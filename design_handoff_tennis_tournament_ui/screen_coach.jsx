  ...
  return (
    <div className="ts-screen ts-tap" style={{ minHeight: '100%', paddingBottom: 90 }}>
      ...
      <div style={{ padding: '16px', background: T.paper, borderBottom: `1px solid ${T.line}` }}>
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gridTemplateRows: '80px 80px', gap: 6 }}>
          <div style={{ gridRow: 'span 2' }}><TsImgSlot h="100%" label="facility" /></div>
          <TsImgSlot h="100%" label="lesson" />
          <TsImgSlot h="100%" label="staff" />
          <TsImgSlot h="100%" label="court" />
          <TsImgSlot h="100%" label="clubhouse" />
        </div>
      </div>
